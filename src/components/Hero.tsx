        ...
        <div className="flex flex-col items-center justify-center mb-12 w-full">
          <div className="overflow-hidden pb-4 w-full">
            <motion.div
              ...
              className="flex justify-center items-center gap-2 md:gap-4 w-full text-[1.75rem] min-[380px]:text-3xl min-[400px]:text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.2] whitespace-nowrap"
            >
          ...
          <div className="overflow-hidden pb-4 w-full">
            <motion.div
              ...
              className="flex justify-center items-center gap-2 md:gap-4 w-full text-[1.75rem] min-[380px]:text-3xl min-[400px]:text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.2] whitespace-nowrap"
            >
              <div className="text-right">Communicate</div>
              <div className="text-left">
          ...
          <div className="overflow-hidden pb-4 w-full">
            <motion.div
              ...
              className="flex justify-center items-center gap-2 md:gap-4 w-full text-[1.75rem] min-[380px]:text-3xl min-[400px]:text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.2] whitespace-nowrap"
            >
              <div className="text-right">Scale</div>
              <div className="text-left">
